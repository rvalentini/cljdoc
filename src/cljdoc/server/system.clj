  ...
  (let [ana-service (cfg/analysis-service env-config)]
    ...
    (merge
     {:cljdoc/tea-time        {}
      ...
      :cljdoc/storage       {:db-spec (ig/ref :cljdoc/postgres)}
      :cljdoc/build-tracker {:db-spec (ig/ref :cljdoc/postgres)}
